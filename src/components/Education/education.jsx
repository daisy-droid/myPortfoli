      ...
      <div className="yeah">
        <div className="grid grid-cols-1 justify-center boom">
          ...
          <div className="grid grid-flow-col auto-cols-max">
            <div className="card w-48 h-56  shadow-xl mt-5 ml-1 mr-">
              <div className="card-body">
        ...
        {/* <div className="grid grid-cols-1  justify-center boom">
          ...
          <div className="grid grid-rows-2 s">
            <div className="certi col-start-1 
             col-end-7 ml-5">
              <div className="card w-48 h-56  shadow-xl mt-5 ml-1 mr-1">
                <div className="card-body pic">
                  <img src={aws} alt="" className="" />

                </div>
              </div>
              <div className="card w-48 h-56 bg-accent-content shadow-xl mt-5 ml-1 mr-1">
                <div className="card-body pic">
                  <img src={azure} alt="" className="" />
