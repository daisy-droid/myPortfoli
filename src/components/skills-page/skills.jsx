...
import nices from "../../images/undraw_designer_life_re_6ywf(1).svg";
    ...
    <div className="skillspage min-h-screen">
      ...
      <div className="left">
        <div className="flex flex-wrap mt-5 ml-5 ">
          <div className="card w-42  shadow-xl mt-5 ml-1 mr-1">
          ...
          <div className="card w-42  shadow-xl mt-5 ml-1 mr-1">
            ...
            <div className="card w-42 shadow-xl mt-5 ml-1 mr-1">
              ...
              >
                <polygon
                  fill="#e7a42b"
                  points="8,5 42,5 38,39 25,43 11,39"
                ></polygon>
                <polygon
                  fill="#f2bf22"
...
//   return(
//     <div>
// <div className="grid grid-rows-1 boom">
// Skills
// <div className="grid grid-rows-2 r">
// hugyftgdxcgvhbjnjkmkl

// </div>
// <div className="grid grid-cols-2 s"></div>
//     </div>
//     </div>
//   )
// }
