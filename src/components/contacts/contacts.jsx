    ...
    >
      ...
      <div className="mb-3 pt-0">
        <input
          ...
          name="name"
          className="px-3 py-3 placeholder-gray-0 text-gray-600 relative bg-white bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-full"
          required
        />
      </div>
      <div className="mb-3 pt-0">
